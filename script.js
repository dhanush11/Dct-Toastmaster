...
// })
// })
  var batch = batches.find(batch => selectHandle.value == batch._id )
  batch.students.forEach((student, i) =>{
    parts.push({'fillStyle' : style[i], 'text' : student.name})
  })

    podiumWheel = new Winwheel({
      'numSegments' : parts.length,
      'outerRadius' : 170,
      'segments' : parts,
      'animation' : {
        'type': 'spinToStop',
